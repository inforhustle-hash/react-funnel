...
export default function App() {
  ...
  const handleBusinessAutomationSubmit = (e) => {
    e.preventDefault();

    const form = e.currentTarget;
    const formData = new FormData(form);

    const email = String(formData.get("e126583") || "").trim().toLowerCase();
    const name = String(formData.get("n126583") || "").trim() || "there";
    ...
    leadParams.append("name", name);
    leadParams.append("email", email);
    leadParams.append("src", "business-automation");
    leadParams.append("notes", "homepage business automation opt-in");

    const webhookUrl =
      "https://n8n-production-01ac.up.railway.app/webhook/lead-log";

    try {
      const blob = new Blob([leadParams.toString()], {
      ...
      console.log("n8n lead logging skipped:", error);
    }
        ...
        <div className="hero-row">
          ...
          <div className="hero-text">
            ...
            >
              ...
              <form
                method="post"
                action="https://www.sendsteed.com/subscribe/"
                onSubmit={handleBusinessAutomationSubmit}
              >
                <input
                  name="e126583"
                  required
